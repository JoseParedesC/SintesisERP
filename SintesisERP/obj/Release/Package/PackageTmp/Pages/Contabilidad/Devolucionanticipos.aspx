<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Devolucionanticipos.aspx.cs"
    Inherits="Devolucionanticipos" MasterPageFile="~/Masters/SintesisMaster.Master" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPage" runat="server">
        ...
        <div class="row" style="margin-left: 0;">
            <div class="x_panel">
                <div class="x_title col-lg-6 col-md-6 col-sm-7 col-xs-12">
                    <h1 class="title-master" style="margin-top: 0;"><span class="fa fa-bullhorn fa-fw"></span>Devolución de Anticipos</h1>
                    ...
                    <div class="row" style="margin: 0px 10px;">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                            <div class="form-group">
                                ...
                                <textarea id="descripcion" max-length="1000" class="form-control" placeholder="Descripción" style="display: block; height: 40px !important; width: 100% !important; max-width: 100%; min-width: 100%; max-height: 300px;" value="">
                                        </textarea>
                            </div>
                        </div>
                    </div>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h2 class="modal-title">Lista de Devoluciones - Anticipos</h2>
                </div>
                                ...
                                <table class="table table-striped jambo_table" id="tbldocumentos">
                                    <thead>
                                        <tr>
                                            ...
                                            <th data-column-id="tercero">Cliente</th>
    ...
    <script src="../Pages/ScriptsPage/Contabilidad/Devanticipos.js?1"></script>
    <script>
