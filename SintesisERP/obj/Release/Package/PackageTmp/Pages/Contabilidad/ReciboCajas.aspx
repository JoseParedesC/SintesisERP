<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReciboCajas.aspx.cs"
    Inherits="ReciboCajas" MasterPageFile="~/Masters/SintesisMaster.Master" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPage" runat="server">
    ...
    <div class="row" style="margin-left: 0;">
        <div class="x_panel">
            <div class="x_title col-lg-5 col-md-5 col-sm-7 col-xs-12">
                <h1 class="title-master" style="margin-top: 0;"><span class="fa fa-level-down fa-fw"></span>Recibos de Cajas</h1>
    ...
    <div class="card" id="diventrada">
        <div class="row" style="margin: 0px 10px;">
            ...
            <div class="col-lg-2 col-md-2 col-sm-4 col-xs-12 sn-padding">
                <div class="form-group">
                    <label for="isReca" class="active">Recaudo ?</label>
                    <div class="check-mail" style="margin-top: 2px">
                        <input type="checkbox" class="i-checks pull-right" id="isReca" />
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 sn-padding divarticleadd" id="divaddart">
                <ul class="nav nav-tabs">
                    <li class="active" id="lidos"><a data-toggle="tab" href="#tab-2" id="tabdos"><i class="fa fa-briefcase"></i>
                        <span class="hidden-xs">Conceptos</span></a></li>
                    <li class="" style="display: none" id="liuno"><a data-toggle="tab" href="#tab-1" id="tabuno"><i class="fa fa-user"></i>
                        <span class="hidden-xs">Cliente</span></a></li>
                </ul>
                            ...
                            <div class="row">
                                        ...
                                        <table class="table table-striped jambo_table" id="tblcommodity" style="font-size: 10.5px">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th data-column-id="cuota_pagar" data-formatter="cuotas" style="width: 3% !important">Cuota No.</th>
                                                    ...
                                                    <th data-column-id="interes" data-formatter="interes">% interes</th>
                                                    <th data-column-id="saldoInteres" data-formatter="saldointeres">Total Interes</th>
                                        ...
                                        <table class="table table-striped jambo_table" id="tblrecibos" style="font-size: 12px">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th data-column-id="pagoCuota" data-formatter="pagoCuota">Abono a Capital</th>
                                                    <th data-column-id="porceInteres">% de Interes</th>
                                                    <th data-column-id="pagoInteres" data-formatter="pagoInteres">Abono a Interes</th>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 sn-padding pull-right">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control actionautocomple inputsearch" id="ds_conceptoDscto" aria-describedby="sizing-addon1" data-search="Bodegas" data-method="BodegasBuscador" data-params="op:Y;o:#;formula:true" data-result="value:name;data:id" data-idvalue="id_conceptoDscto" />
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="tab-2" class="tab-pane active  ">
                        <div class="card" style="padding-left: 13px">
                            <div class="row" style="margin: 0 1px;">
                                <div role="alert" aria-live="polite" aria-atomic="true" class="alert alert-dismissible alert-alert alert-card alert-info" style="    margin-right: 12px; margin-bottom: 0px; margin-top: 5px; padding:5px; font-size: 10px;">
                                    <strong class="text-capitalize">Información!</strong> Los conceptos deben ser de naturaleza credito.
                                </div>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 sn-padding">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" id="typedoc" value="CAJAS" />
                                        <input type="text" class="form-control actionautocomple inputsearch" id="ds_concepto" aria-describedby="sizing-addon1" data-search="Bodegas" data-method="BodegasBuscador" data-params="op:Q;o:#;formula:false;tipo:CAJAS" data-result="value:name;data:id" data-idvalue="id_concepto" />
                                ...
                                <table class="table table-striped jambo_table" id="tblcuotasxfact">
                                    <thead>
                                        <tr>
                                            ...
                                            <th data-column-id="diasdevenci" style="width: 3% !important">Dias vencidos</th>
                                            <th data-column-id="interes" data-formatter="interes">Interes</th>
                                            <th data-column-id="Tinteres" data-formatter="Tinteres">Total Interes</th>
                                        </tr>
                                    </thead>
                                </table>
                            </div>
    ...
    <script src="../Pages/ScriptsPage/Contabilidad/RecibosCaja.js?1"></script>
    <script>
