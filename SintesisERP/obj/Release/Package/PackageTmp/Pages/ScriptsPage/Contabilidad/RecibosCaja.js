    ...
    window.gridbod = $("#tblcommodity").bootgrid({
        ...
        formatters: {
            ...
            "state": function (column, row) {
                return "<a class=\"action command-state\"   data-row-id=\"" + row.id + "\" data-row-factura=\"" + row.factura + "\"   data-row-vlr=\"" + row.valorcuota + "\" data-row-saldoc=\"" + row.saldocuota + "\"   data-row-dias=\"" + row.diasvencido + "\" data-row-interesabonado=\"" + row.interesabono + "\"  >" +
    ...
    window.gridbod.find(".command-state").each(function () {
        ...
        if (state.attr('class') == 'fa fa-2x fa-fw fa-check-square-o text-success  iconfa') {
            if (SetNumber($('#pay' + $(this).data("row-id")).html()) > 0) {
                pagosXML += '<pago id_factura="' + $(this).data("row-factura") + '" valor="' + SetNumber(($('#pay' + $(this).data("row-id")).html())) + '" porceInteres="' + SetNumber(($('#interes' + $(this).data("row-id")).html())) + '" interes="' + SetNumber(($('#saldointeres' + $(this).data("row-id")).html())) + '" dias="' + $(this).data("row-dias")  + '"/>'
            } else {
                facturar = false;
