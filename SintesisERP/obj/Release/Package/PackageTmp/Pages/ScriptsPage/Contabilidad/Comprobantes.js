...
function newComprobante() {
    ...
    $('#btnSave, #btnTemp,  #btnconf, #btnLoad,#cd_tipodoc,.btnsearch,#descripcion,#cd_movimiento,m_valor,#detalle').removeAttr('disabled');
    $('.dropify-clear').click();
...
$(document).ready(function () {
    ...
    $('#addarticle').click(function (e) {
        if (validate(JsonCommodity)) {
            ...
            Parameter.fechavencimiento = $('#ds_factura').val() != "" ? SetDate($('#ds_saldo').val()) : null;
