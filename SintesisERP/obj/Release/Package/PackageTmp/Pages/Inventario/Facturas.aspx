<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Facturas.aspx.cs"
    Inherits="Facturas" MasterPageFile="~/Masters/SintesisMaster.Master" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPage" runat="server">
    ...
    <div class="row" style="margin-left: 0;">
        <div class="x_panel">
            <div class="x_title col-lg-6 col-md-6 col-sm-7 col-xs-12">
                <h1 class="title-master" style="margin-top: 0;"><span class="fa fa-fw iconbox icon-facturacion"></span>Facturación</h1>
            ...
            <div class="col-lg-6 col-md-6 col-sm-5 col-xs-12 Botns">
                ...
                <button title="Imprimir Factura" id="btnPrint" data-option="I" class="btn btn-outline btn-print dim  pull-right" type="button"><i class="fa fa-print"></i></button>
                <%--modificado 20/01--%>
                <div class="group" role="group" aria-label="Button group with nested dropdown">
                    <div id="btngrupo" class="btn-group group1 Botns pull-right" role="group" style="display: none">
                        <button title="Concluir" style="border-radius: 6px; height: 35px; width: 35px; color: #4389b5; font-size: 20px; text-align: center" id="btnConc" data-option="UC"
                            class="btn btn-outline btn-success dim pull-right btn-add dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" type="button">
                        ...
                        <div class="dropdown-menu" id="dropdown-menu" aria-labelledby="btnGroupDrop1">
                            <a class="dropdown-item" href="#">
                                <button title="Imprimir Factura" id="btnPrintt" data-option="I" class="btn btn-outline btn-print dim  pull-right" type="button"><i class="fa fa-print"></i></button>
                            </a>
                            <a class="dropdown-item" href="#">
                                <button title="Imprimir Amortizacion" id="btnPrintTableCuota" data-option="C" class="btn btn-outline btn-warning dim  pull-right" type="button"><i class="fa fa-print"></i></button>
                            </a>
                        </div>
                    </div>
                </div>
    ...
    <div class="card" id="diventrada" style="padding-bottom: 30px;">
        <div class="row" style="margin: 0px 10px;">
            ...
            <div class="col-lg-2 col-md-3 col-sm-4 col-xs-12 sn-padding ">
                <div class="form-group">
                    <label for="SelectForma" class="active">Forma de pago:</label>
                    <select runat="server" clientidmode="static" id="SelectForma" class="form-control selectpicker" data-size="8">
                    </select>
                </div>
            </div>
            ...
            <div class="col-lg-2 col-md-3 col-sm-4 col-xs-12 sn-padding">
                <div class="form-group">
                    <label for="m_discountfin" class="active">Dsto Financiero:</label>
            ...
            <div class="col-lg-2 col-md-3 col-sm-4 col-xs-12 sn-padding">
                <div class="form-group">
                    <label for="Text_Nombre" class="active">Cuenta de Dsto Financiero:</label>
            ...
            <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12" style="padding: 0;">
                <div class="col-lg-2 col-md-3 col-sm-3 col-xs-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="country" id="v_code" class="form-control actionautocomple" placeholder=" " data-search="Productos" data-endcallback="SelecProducto" data-method="ArticulosBuscador" data-params="op:A;o:#;formula:true;id_prod:0;" data-result="value:name;data:id;inventarial:inventarial" />
                    </div>
                </div>
                    ...
                    <div class="table-responsive" style="border: none;">
                        ...
                        <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 sn_padding" style="border-bottom: 1px solid #e7eaec">
                            <div class="ibox-content codvalue text-right">
                                ...
                                <span class="font-bold text-navy">Dsto Comercial</span>
                            </div>
                        </div>
                        <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 sn_padding" style="border-bottom: 1px solid #e7eaec">
                            <div class="ibox-content codvalue text-right">
                                ...
                                <table class="table table-striped jambo_table" id="tblfacturas">
                                    <thead>
                                        <tr>
                                            ...
                                            <th data-formatter="Imprimir" data-sortable="false">Amortizacion</th>
                                        </tr>
                                    </thead>
                                </table>
                            </div>
    ...
    <div class="modal fade" id="ModalFormas">
        <div class="modal-dialog " role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" id="btncancemodal" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                ...
                <div class="modal-body clearfix" style="margin-bottom: 0; padding-top: 0 !important">
                    <div class="row">
                        ...
                        <%--AQUI SE VA AGREGAR PAGO DECONTADO--%>
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 sn_padding text-center">
                            <div id="pagoContado" class="col-lg-12 col-md-12">
                                <h3 style="text-align: center">Detalle de pago decontado</h3>
                                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6 sn-padding">
                                    <div class="form-group">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-3 col-xs-8 sn-padding">
                                    <div class="form-group">
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12" style="padding: 10px;">
                                    <div class="table-responsive" style="max-height: 200px">
                                        <table class="table table-striped text-center" id="tblpagos">
                                            <thead>
                                                <tr>
                            ...
                            <%---------------------------DETALLES DE PAGO ACREDITO------------------------------------%>

                            <div id="pagoCredito" class="col-lg-12" style="margin-bottom: 2%; text-align: right;">
                                <h3 style="text-align: center">Detalle de pago</h3>
                                <div class="col-lg-4 col-md-12 col-sm-4 col-xs-12 sn-padding" id="PagoAcreditos">
                                    <div class="form-group">
                                ...
                                <div class="col-lg-5 col-md-4 col-sm-4 col-xs-12 sn-padding">
                                    <div class="form-group">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 sn-padding" id="Tipovencimi">
                                    <div class="form-group">
                                ...
                                <div id="numdias" class="col-lg-2 col-md-3 col-sm-3 col-xs-12 sn-padding">
                                    <div class="form-group">
                                ...
                                <div style="display: none;" id="CuotaCredi">
                                    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 sn-padding">
                                        <div class="form-group">
                                            <label for="valorforma" class="active">Valor Cuota</label>
                                            <input type="text" class="form-control" id="valorCuotacre" money="true" data-a-dec="." data-a-sep="," data-m-dec="2" data-v-min="0" data-v-max="999999999999.99" value="0" data-a-sign="$ " disabled />
                                        </div>
                                    </div>

                                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 sn-padding" id="ValorCuotaFinanza">
                                        <div class="form-group">
                                ...
                                <div class="col-lg-1 col-md-2 col-sm-1 col-xs-12 sn-padding">
                                ...
                                <div class="col-lg-1 col-md-2 col-sm-3 col-xs-12 sn-padding" style="margin-left: 9px">
                                    <button id="DetalleCuota" type="button" data-option="F" class="btn btn-sin btn-circle addarticle" title="Detalles Cuota"><i class="fa fa-calendar"></i></button>
                                </div>
                            </div>

                            <div id="ContenedorCuota" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 sn-padding">
                                <h3 style="text-align: center">Detalle de Cuotas</h3>
                                <div class="table-responsive" style="max-height: 150px">
                                    <table class="table table-striped" id="tblpagoscre" data-cuotas="0" data-inicial="" data-tipoven="0" data-dias="0">
                                        <thead>
                                            <tr>
                    ...
                    <div class="row col-lg-12" style="margin-top: 5%;">
                        <div class="col-lg-3 col-md-3 col-xs-12 col-sm-12 sn_padding NOcredito" style="border-bottom: 1px solid #e7eaec;">
                            <div class="ibox-content codvalue text-right">
                        ...
                        <div class="col-lg-3 col-md-3 col-xs-12 col-sm-12 sn_padding NOcredito" style="border-bottom: 1px solid #e7eaec; margin-bottom: 4px;">
                            <div class="ibox-content codvalue  text-right">
                        ...
                        <div class="col-lg-3 col-md-3 col-xs-12 col-sm-12 sn_padding NOcredito" style="border-bottom: 1px solid #e7eaec; margin-bottom: 4px;">
                            <div class="ibox-content codvalue  text-right">
                                <h4 id="TCredito" class="no-margins">$ 0.00</h4>
    ...
    <script src="../Pages/ScriptsPage/Inventario/Facturas.js?3"></script>
    <script>
