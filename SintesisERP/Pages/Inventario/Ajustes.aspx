<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Ajustes.aspx.cs"
    Inherits="Ajustes" MasterPageFile="~/Masters/SintesisMaster.Master" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPage" runat="server">
    ...
    <div class="row" style="margin-left: 0;">
        <div class="x_panel">
            <div class="x_title col-lg-5 col-md-5 col-sm-7 col-xs-12">
                <h1 class="title-master" style="margin-top: 0;"><span class="fa fa-level-down fa-fw"></span>Ajustes de Inventario</h1>
                <div class="clearfix"></div>
            </div>
            <div class="col-lg-7 col-md-7 col-sm-5 col-xs-12 Botns">
                <input type="hidden" id="id_ajuste" value="0" />
                <input type="hidden" id="idToken" value="0" />
                <input type="hidden" id="serie" />
                <input type="hidden" id="series" />
                <input type="hidden" id="opTipoAjustes" value="T" />
        ...
        <div class="row" style="margin: 0px 10px;">
            ...
            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12 sn-padding">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control actionautocomple inputsearch" id="ds_concepto" aria-describedby="sizing-addon1" data-search="Bodegas" data-method="BodegasBuscador" data-params="op:Y;o:#" data-result="value:name;data:id" data-idvalue="cd_concepto" />
                </div>
            </div>
            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12 sn-padding">
                <div class="form-group">
                    <label for="cd_wineridef" class="active">Bodega Por Defecto:</label>
            ...
            <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12" style="padding: 0;">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 divarticleadd" style="padding: 0;">
                    <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 sn-padding">
                        <div class="form-group">
                            <label for="cd_wineri" class="active">Bodega:</label>
                           <input type="hidden" id="cd_wineri" value="0"/>
                            <input type="text" class="form-control actionautocomple inputsearch"  id="bod" aria-describedby="sizing-addon1" data-search="Bodegas" data-method="BodegasBuscador" data-params="op:Z;o:#" data-result="value:name;data:id" data-idvalue="cd_wineri"/>                       
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 sn-padding">
                        <div class="form-group">
                    ...
                    <div class="col-lg-1 col-md-1 col-sm-6 col-xs-12 sn-padding">
                        <div class="form-group">
                            ...
                            <input id="m_quantity" type="text" class="form-control" placeholder=" " money="true" data-a-dec="." data-a-sep="," data-m-dec="2" data-v-min="-999999999.99" data-v-max="999999999.99" value="0.00" />
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 sn-padding">
                        <div class="form-group">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 divserie sn-padding" style="display: none">
                        <div class="form-group">
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h2 class="modal-title">Lista de Ajustes</h2>
                </div>
                <div class="modal-body clearfix" style="margin-bottom: 0; padding-top: 0 !important">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 5px;">
                            <div class="table-responsive" style="max-height: 300px">
                                <table class="table table-striped jambo_table" id="tblajustes">
                                    <thead>
                                        <tr>
    ...
    <script src="../Pages/ScriptsPage/Inventario/Ajustes.js?1"></script>
    <script>
