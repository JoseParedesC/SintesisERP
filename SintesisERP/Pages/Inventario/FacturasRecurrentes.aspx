<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FacturasRecurrentes.aspx.cs"
    Inherits="FacturasRecurrentes" MasterPageFile="~/Masters/SintesisMaster.Master" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPage" runat="server">
    ...
    <div class="row" style="margin-left: 0;">
        <div class="x_panel">
            <div class="x_title col-lg-6 col-md-6 col-sm-7 col-xs-12">
                <h1 class="title-master" style="margin-top: 0;"><span class="fa fa-fw iconbox icon-facturacion"></span>Facturas Recurrentes</h1>
                <div class="clearfix"></div>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-5 col-xs-12 Botns">
                <input type="hidden" id="opTipoFactura" value="T" />
                  <input type="hidden" id="mostrarIcon" value="K" />
                <button title="Facturar" id="btnFactu" data-option="F" class="mintip btn btn-outline btn-primary dim waves-effect waves-light pull-right btn-loading-state" data-loading-text="<i class='fa fa-spinner fa-spin'></i>" type="button"><i class="fa fa-paste"></i></button>
        ...
        <div class="row" style="margin: 0px 10px;">
            ...
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12 sn-padding">
                <div class="form-group">
                    ...
                    <input type="hidden" id="cd_cliente" value="0" data-op="C" />
            ...
            <div class="col-lg-2 col-md-3 col-sm-3 col-xs-12 padsmall  sn-padding">
                <div class="form-group">
                    <label for="cd_formapagos" class="active">Forma de Pago:</label>
                    <select runat="server" clientidmode="static" id="cd_formapagos" class="form-control selectpicker" data-size="8">
                    </select>
                </div>
            </div>
        </div>
    ...
    <input type="hidden" value="N" id="edittable" />
            ...
            <div class="modal-content">
                ...
                <div class="modal-body clearfix" style="margin-bottom: 0; padding-top: 0 !important">
                    <div class="row">
                                ...
                                <table class="table table-striped jambo_table" id="tblfacturas">
                                    <thead>
                                        <tr>
                                            ...
                                            <th data-column-id="editar" data-formatter="editar" data-sortable="false" style="max-width: 30px !important;">Editar</th>
                                            <th data-column-id="factu" data-formatter="factu" data-sortable="false" style="max-width: 30px !important;">Seleccionar</th>
                      ...
                      <div class="row buttonaction pull-right">
                                <button title="Guardar" id="btnguardar" data-option="F" class="btn btn-outline btn-primary dim waves-effect waves-light" type="button"><i class="fa fa-paste"></i></button>
                                <button title="Cancelar" id="btnCancee" class="btn btn-outline btn-danger  dim waves-effect waves-light" data-dismiss="modal" aria-label="Close" type="button"><i class="fa-file-o fa"></i></button>
                            </div>
                </div>
            </div>
        </div>
    ...
    <script src="../Pages/ScriptsPage/Inventario/FacturasRecurrentes.js?1"></script>
    <script>
