<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Marcas.aspx.cs" Inherits="Marcas" MasterPageFile="~/Masters/SintesisMaster.Master" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPage" runat="server">
    ...
    <div class="row" style="margin-left: 0;">
        <div class="x_panel">
            <div class="x_title">
                <h1 class="title-master" style="margin-top: 0;"><span class="fa fa-bullhorn fa-fw"></span>Maestro Marcas</h1>
        ...
        <div class="row" style="margin: 0px 10px;">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-top: 5px; padding-bottom: 15px; padding-left: 2px;">
                <div class="table-responsive ">
                    <table class="table table-striped jambo_table" id="tblmarcas">
                        <thead>
                            <tr>
    ...
    <div class="modal fade" id="ModalMarcas">
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h2 class="modal-title">Detalle Marca</h2>
                </div>
    ...
    <script src="../Pages/ScriptsPage/Inventario/Marcas.js?1"></script>
</asp:Content>
