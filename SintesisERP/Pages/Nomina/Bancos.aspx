<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Bancos.aspx.cs"
    Inherits="Bancos" MasterPageFile="~/Masters/SintesisMaster.Master" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPage" runat="server">
    ...
    <div class="wrapper wrapper-content" style="padding-top: 5px; background: #fff !important;">
        <div class="row" style="margin-left: 0;">
            <div class="x_panel">
                <div class="x_title">
                    <h1 class="title-master" style="margin-top: 0;"><span class="fa fa-bullhorn fa-fw"></span>Maestro de Bancos</h1>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-top: 5px; padding-bottom: 15px; padding-left: 2px;">
                    <div class="table-responsive">
                        ...
                        <table class="table table-striped jambo_table" id="tblbancos">
                            <thead>
                                <tr>
                                    <th data-column-id="edit" data-formatter="edit" data-sortable="false" style="max-width: 30px !important;">Editar</th>
                                    <th data-column-id="nombre">Nombre</th>
                                    <th data-column-id="estado" data-formatter="estado" data-sortable="false" style="max-width: 30px">Estado</th>
    ...
    <script src="../Pages/ScriptsPage/Nomina/Bancos.js?1"></script>
