<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Pila.aspx.cs"
    Inherits="Pila" MasterPageFile="~/Masters/SintesisMaster.Master" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPage" runat="server">
    ...
    <div class="wrapper wrapper-content" style="padding-top: 5px; background: #fff !important;">
        <div class="row" style="margin-left: 0;">
            <div class="x_panel">
                <div class="x_title">
                    <h1 class="title-master" style="margin-top: 0;"><span class="fa fa-bullhorn fa-fw"></span>Maestro de Pila</h1>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-top: 5px; padding-bottom: 15px; padding-left: 2px;">
                    <div class="table-responsive">
                        ...
                        <table class="table table-striped jambo_table" id="tblpila">
                            <thead>
                                <tr>
    ...
    <div class="modal fade " id="ModalPila">
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h2 class="modal-title">Pila</h2>
                </div>
                <div class="modal-body clearfix" style="margin-bottom: 0;">
                    <div class=" row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12  sn-padding">
                            <div class="form-group">
                                <label for="nombrepila" class="active">Nombre</label>
                                <input type="text" class="form-control" id="nombrepila" />
                            </div>
                        </div>
                        <div class="form-group">
    ...
    <script src="../Pages/ScriptsPage/Nomina/Pila.js"></script>
