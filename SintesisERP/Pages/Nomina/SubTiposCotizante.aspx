<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SubTiposCotizante.aspx.cs"
    Inherits="SubTiposCotizante" MasterPageFile="~/Masters/SintesisMaster.Master" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="ContentPage" runat="server">
    ...
    <div>
     ...
     <div class="row" style="margin: 0px 10px;">
            <div class="x_panel">
                <div class="x_title">
                    <h1 class="title-master" style="margin-top: 0;"><span class="fa fa-1x fa-user fa-fw"></span>Maestro Subtipos de Cotizante</h1>
        ...
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h2 class="modal-title">Detalles Subtipo Cotizante</h2>
                </div>
    ...
    <script src="../Pages/ScriptsPage/Nomina/SubTiposCotizante.js?9"></script>
