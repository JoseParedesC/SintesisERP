                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 divarticleadd" style="padding: 0;">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 sn-padding cred">
                        <div class="form-group">
                            ...
                            <div class="input-group ">
                                ...
                                <input type="text" class="form-control inputsearch" placeholder=" "  id="ds_factura" aria-describedby="sizing-addon1" />
                                <span class="input-group-addon ">
                                    <button type="button" class="btn btn-primary btnsearch" data-search="NotasCartera" data-method="SaldosList" data-title="Facturas" data-select="1,2" data-column="id,factura,Cuenta" data-fields="cd_factura,ds_factura" data-params="tipoterce,tipotercero1;id_tercero,cd_cliente;fecha,fechadoc;cuenta,id_ctacon">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 sn-padding " id="vencicliente">
                        <div class="form-group">
                            ...
                            <div class="input-group ">
                                ...
                                <input type="text" class="form-control inputsearch" placeholder=" "  id="ds_saldo" aria-describedby="sizing-addon1" current="true" date="true" format="YYYY-MM-DD" />
                                <span class="input-group-addon ">
                                    <button type="button" class="btn btn-primary btnsearch" data-search="NotasCartera" data-method="SaldosCuotaList" data-title="Cuotas" data-select="1,2" data-column="id,vencimiento,saldoactual" data-fields="cd_idsaldo,ds_saldo" data-params="nrofactura,cd_factura1;id_tercero,cd_cliente;fecha,fechadoc1;cuenta,id_ctacon">
                                        <i class="fa fa-fw fa-search"></i>
                                    </button>
                                </span>
                            </div>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 sn-padding " id="venciproveedor">
                        <div class="form-group">
                            ...
                            <input id="Text_FechaVenpro" type="text" placeholder=" " class="form-control" current="true" date="true" format="YYYY-MM-DD"  />
                        </div>
                    </div>
