...
public partial class Devolucionanticipos : Session_Entity
{
    protected void PageLoad()
    {
        Result data = dbase.FW_LoadSelector("TIPODOCUMENTOS", Usuario.UserId, "ANTICIPOS").RunData();
        ...
        data = dbase.FW_LoadSelector("FORMAPAGOS", Usuario.UserId, "CONVENCIO").RunData();
