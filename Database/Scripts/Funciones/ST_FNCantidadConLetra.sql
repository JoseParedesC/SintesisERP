...
If EXISTS (SELECT 1 FROM dbo.SYSOBJECTS WHERE id = OBJECT_ID(N'[dbo].[ST_FNCantidadConLetra]') and OBJECTPROPERTY(id, N'IsScalarFunction') = 1)
DROP FUNCTION [dbo].[ST_FNCantidadConLetra]
GO
CREATE FUNCTION [dbo].[ST_FNCantidadConLetra]
(
    @Numero             Decimal(18,2)
)
RETURNS Varchar(180)
