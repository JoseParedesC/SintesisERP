...
***************************************/SELECT E.id id, CONVERT(VARCHAR(6), E.fecha, 112) ANOMES, E.id_centrocosto CENTROCOSTO, E.id NRODOCUMENTO, '' nrofactura, CONVERT(varchar, E.FECHA, 111) FECHADCTO, C.id CUENTA, 
...
UNION
SELECT E.id id,CONVERT(VARCHAR(6), E.fecha, 112) ANOMES, E.id_centrocosto CENTROCOSTO, E.id NRODOCUMENTO, '' nrofactura, CONVERT(varchar, E.FECHA, 111) FECHADCTO, A.id_ctacontable CUENTA, 
