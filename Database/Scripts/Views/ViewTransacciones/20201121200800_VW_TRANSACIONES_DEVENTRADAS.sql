...
***************************************/SELECT E.id id, CONVERT(VARCHAR(6), E.fechadocumen, 112) ANOMES, E.id_centrocostos CENTROCOSTO, E.id NRODOCUMENTO, M.numfactura nrofactura, CONVERT(varchar, M.rptfechadocumen, 111) FECHADCTO, 
...
UNION 
SELECT		E.id id, CONVERT(VARCHAR(6), E.fechadocumen, 112) ANOMES, E.id_centrocostos CENTROCOSTO, E.id NRODOCUMENTO, D.numfactura nrofactura, CONVERT(varchar, E.fechadocumen, 111) FECHADCTO, 
...
UNION
SELECT      DF.id id, CONVERT(VARCHAR(6), DF.fechadocumen, 112) ANOMES, DF.id_centrocostos CENTROCOSTO, DF.id NRODOCUMENTO, F.numfactura nrofactura, CONVERT(varchar, DF.fechadocumen, 111) FECHADCTO, 
