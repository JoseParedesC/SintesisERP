...
***************************************/
SELECT		E.id id, CONVERT(VARCHAR(6), E.fechadocumen, 112) ANOMES, E.id_centrocostos CENTROCOSTO, E.id NRODOCUMENTO, E.numfactura nrofactura, CONVERT(varchar, E.fechadocumen, 111) FECHADCTO, 
