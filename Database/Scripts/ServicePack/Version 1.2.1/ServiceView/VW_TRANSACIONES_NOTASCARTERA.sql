...
***************************************/ SELECT E.id id,CONVERT(VARCHAR(6), rptfecha, 112) ANOMES, IIF(E.id_centrocosto=0,null,E.Id_centrocosto) CENTROCOSTO, E.id NRODOCUMENTO, S.nrofactura nrofactura, CONVERT(varchar, E.FECHA, 112) FECHADCTO, S.id_cuenta CUENTA, 
...
UNION
 SELECT E.id id,CONVERT(VARCHAR(6), rptfecha, 112) ANOMES, IIF(E.id_centrocosto=0,null,E.Id_centrocosto) CENTROCOSTO, E.id NRODOCUMENTO, E.nrofactura nrofactura, CONVERT(varchar, E.FECHA, 112) FECHADCTO, IIF(E.id_ctaact is null,E.id_ctaant,E.id_ctaact) CUENTA, 
...
WHERE  (E.id_estado =Dbo.ST_FnGetIdList('PROCE')) AND  S.saldoActual>0  
UNION
SELECT E.id id,CONVERT(VARCHAR(6), rptfecha, 112) ANOMES, IIF(E.id_centrocosto=0,null,E.Id_centrocosto) CENTROCOSTO, E.id NRODOCUMENTO, F.nrofactura nrofactura, CONVERT(varchar, E.FECHA, 112) FECHADCTO, F.id_cuenta CUENTA, 
