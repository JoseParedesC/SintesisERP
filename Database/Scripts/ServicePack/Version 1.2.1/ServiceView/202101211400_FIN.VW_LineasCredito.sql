...
AS
SELECT        t.id, t.Codigo, t.Nombre, t.id_ctacredito, t.Tasaanual, A.codigo + '-' + A.nombre AS CuentaCredito, t.id_ctaintcorriente, t.id_ctaiva, t.ivaIncluido, t.porcenIva, 
t.id_ctamora, t.id_ctaantFianza,  N.codigo + '-' + N.nombre AS CuentaFianza,  t.Porcentaje, B.codigo + '-' + B.nombre AS CuentaCorriente, C.codigo + '-' + C.nombre AS CuentaMora, D.codigo + '-' + D.nombre AS iva, t.iva AS Estado, t.created, 
                         t.updated, t.id_user
