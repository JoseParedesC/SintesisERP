...
SELECT R.id,R.id_recibo,R.id_concepto,P.nombre concepto,R.valor,C.codigo CodigoCuenta FROM CNT.MovReciboCajasConcepto R INNER JOIN dbo.productos P
	   on R.id_concepto=P.id INNER JOIN CNTCuentas C ON P.id_ctacontable=C.id
GO
