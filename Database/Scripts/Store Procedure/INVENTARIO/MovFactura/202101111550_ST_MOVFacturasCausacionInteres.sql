...
BEGIN TRY
	...
	SET @id_factura = (SELECT TOP 1 id_documento FROM FIN.SaldoCliente WHERE nrofactura = @numfactura AND id_cliente = @id_tercero);
	...
	id_tipovence, estadoFE, id_user, id_vendedor, iscausacion, id_ctafin, fechavence, nrofactura)
	SELECT 
	id_tipodoc,
	id_centrocostos,
