...
If EXISTS (SELECT 1 FROM dbo.SYSOBJECTS WHERE id = OBJECT_ID(N'[dbo].[ST_MovFacturasListPos]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
DROP PROCEDURE [dbo].[ST_MovFacturasListPos]
GO

CREATE PROCEDURE [dbo].[ST_MovFacturasListPos]
	@page INT = 1,
	@numpage INT = 10,
