...
BEGIN TRY
	...
	BEGIN		
		...
		SELECT @codigo, @codigopadre+@codigo, @nombre, @tipo, @codigopadre, @id_user, 0, @indice, @idparent, CASE WHEN @id_tipocta = 0 THEN NULL ELSE @id_tipocta END,@id_naturaleza,@id_categoria
